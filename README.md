...
`main_fiber.py` - illustrates the available material models within fkit. Refer to the [documentation](https://github.com/wcfrobert/fkit/tree/master/doc#fiber-material-models) for more info.
...
Each of the eight material models above can be assigned to either a **Node** fiber or a **Patch** fiber:
